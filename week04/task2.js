...
const myPhoto = 'images/innocent.jpeg';
...
const foodArray = ['Pork', 'Chicken', 'Pasta', 'Pizza', 'Lasagna'];
...
const otherfoodArray = ['Sadza', 'Potato'];

// Step 4: add the variable holding another favorite food to the favorite food array
const favoriteFoods = foodArray.concat(otherfoodArray);
